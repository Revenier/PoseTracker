...
def situp_landmarks():        return _read_csv("situp_landmarks_raw.csv")
def situp_angles():           return _read_csv("situp_angles_raw.csv")
...
posture_map = {
    ...
    "situp":       {"landmarks": situp_landmarks,       "angles": situp_angles},
